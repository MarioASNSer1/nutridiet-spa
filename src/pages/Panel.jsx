        ...
        <Row>
          ...
          <Col md={8}>
            ...
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <strong>Peso:</strong> 72 kg
              </ListGroup.Item>
              <ListGroup.Item>
                <strong>Altura:</strong> 1.74 m
              </ListGroup.Item>
              <ListGroup.Item>
                <strong>Objetivo:</strong> Reducción de grasa
              </ListGroup.Item>
              <ListGroup.Item>
                <strong>Plan actual:</strong> Intermedio
              </ListGroup.Item>
            </ListGroup>
          </Col>
        </Row>
      ...
      <Row className="gy-4">
        ...
        <Col md={4}>
          <Card className="p-3 shadow-sm h-100">
            ...
            <ListGroup variant="flush">
              <ListGroup.Item>
                <strong>Calorías diarias:</strong> 1 950 kcal
              </ListGroup.Item>
              <ListGroup.Item>
                <strong>Proteínas:</strong> 120 g
              </ListGroup.Item>
              <ListGroup.Item>
                <strong>Carbohidratos:</strong> 200 g
              </ListGroup.Item>
              <ListGroup.Item>
                <strong>Grasas:</strong> 55 g
              </ListGroup.Item>
            </ListGroup>
          </Card>
        </Col>
        ...
        <Col md={4}>
          <Card className="p-3 shadow-sm h-100">
            ...
            <ListGroup variant="flush">
              ...
              <ListGroup.Item>
                <strong>Miembro desde:</strong> 12 ene 2025
              </ListGroup.Item>
            </ListGroup>
          </Card>
        </Col>
        ...
        <Col md={4}>
          <Card className="p-3 shadow-sm h-100">
            ...
            <ListGroup variant="flush">
              <ListGroup.Item>
                <strong>Plan:</strong> Intermedio mensual
              </ListGroup.Item>
              <ListGroup.Item>
              ...
              <ListGroup.Item>
                <strong>Próximo cargo:</strong> 15 jul 2025
              </ListGroup.Item>
              <ListGroup.Item>
                <strong>Método de pago:</strong> Visa •••• 4242
              </ListGroup.Item>
            </ListGroup>
          </Card>
        </Col>
